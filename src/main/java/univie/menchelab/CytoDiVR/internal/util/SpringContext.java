...
public class SpringContext {
        ...
        @Tunable(description = "Optimal distance",
                        groups = {"DataDiVR variables", "Layout", "Parameters", "Spring"},
                        params = "displayState=collapsed", longDescription = OD_DESC,
                        tooltip = OD_DESC, format = Utility.FLOAT_FORMAT, gravity = 3)
        ...
        @Tunable(description = "Iterations",
                        groups = {"DataDiVR variables", "Layout", "Parameters", "Spring"},
                        params = "displayState=collapsed", longDescription = IT_DESC,
                        tooltip = IT_DESC, gravity = 3)
        ...
        @Tunable(description = "Threshold",
                        groups = {"DataDiVR variables", "Layout", "Parameters", "Spring"},
                        params = "displayState=collapsed", longDescription = IT_DESC,
                        tooltip = IT_DESC, format = Utility.FLOAT_FORMAT, gravity = 3)
