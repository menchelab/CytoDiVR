package univie.menchelab.DataDiVRApp.internal;
...
import univie.menchelab.DataDiVRApp.internal.tasks.ExportNetworkFactory;
import univie.menchelab.DataDiVRApp.internal.tasks.SendNetworkFactory;
import univie.menchelab.DataDiVRApp.internal.test.TestSendFactory;
...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		props.setProperty(PREFERRED_MENU, "Apps.DataDiVR");
		...
		logger.info("DataDiVRApp " + version + " initialized.");
		System.out.println("DataDiVRApp " + version + " initialized.");
